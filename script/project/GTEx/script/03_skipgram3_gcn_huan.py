...
lookup_table =  np.load("/public/home/huanhuan/project/GTEx/output/model/03_skipgram_gcn_date09_11_21_37_lookup_table.npy")
...
def compute_acc(lookup_table,source_file):
    ...
    np.save(os.path.join(root_path,r'record', rf'03_skipgram_gcn_09_11_21_37_auc.npy'),d)

np.save(os.path.join(root_path,r'record', rf'03_skipgram_gcn_09_11_21_37_similarity_mtx.npy'),similarity_mtx)
roc_auc = auc(fpr,tpr)
plt.figure()
lw=2
...
plt.savefig("/public/home/huanhuan/project/GTEx/output/figure/03_gcn_hotspot_egene_09_11_21_37_auc.png",dpi=600)#保存图片，dpi设置分辨率
plt.show()
...
similarity_df.to_csv("/public/home/huanhuan/project/GTEx/output/03_smiliarity.txt",sep="\t",index=None)
